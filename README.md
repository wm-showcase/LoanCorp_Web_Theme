...
--------
To clone the LoanCorp_Web_Theme repository, use git clone:

<pre>
 git clone https://github.com/wm-showcase/LoanCorp_Web_Theme.git
 cd LoanCorp_Web_Theme
 npm install
</pre>
...
Build
--------
To build the WaveMaker Theme run the below command from LoanCorp_Web_Theme directory
